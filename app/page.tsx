...
export default function CheckoutPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="flex md:flex-row flex-col-reverse justify-center lg:gap-[52px] gap-6 md:gap-8  bg-white">

        {/* Contact Form - Takes 2 columns */}
        <div className=" bg-white  lg:pr-[100px] max-md:px-4 md:pr-10 py-10 ">
        ...
        <div className=" flex-1   lg:pl-[100px] md:pl-12   md:pr-10  bg-gray-100  md:py-10">
